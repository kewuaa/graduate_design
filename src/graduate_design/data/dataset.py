...
def init() -> int:
    ...
    ''')
    global data_path
    data_path = data_path / f'{img_size}x{img_size}_{img_num}_{pixel}_{graph_size}_{graph_num}_{graph_type}_{angle}_{theta_step}_{"with" if add_noise else "without"}_noise'
