...
/* "graduate_design/cylib/circle.pyx":27
 *         double left, bottom, width, height, center[2]
...
static int __pyx_pw_15graduate_design_5cylib_6circle_6Circle_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    __pyx_v_left = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_left == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 29, __pyx_L3_error)
    __pyx_v_right = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_right == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L3_error)
    __pyx_v_bottom = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_bottom == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 31, __pyx_L3_error)
    __pyx_v_top = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_top == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L3_error)
    __pyx_v_min_size = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_min_size == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L3_error)
    __pyx_v_max_size = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_max_size == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 34, __pyx_L3_error)
  }
...
static int __pyx_pf_15graduate_design_5cylib_6circle_6Circle___init__(struct __pyx_obj_15graduate_design_5cylib_6circle_Circle *__pyx_v_self, double __pyx_v_left, double __pyx_v_right, double __pyx_v_bottom, double __pyx_v_top, double __pyx_v_min_size, double __pyx_v_max_size) {
  ...
  /* "graduate_design/cylib/circle.pyx":36
 *         double max_size
 *     ):
 *         self.left = left             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "graduate_design/cylib/circle.pyx":46
 *         self.inscribed_r = c_min(self.width, self.height) / 2
 * 
 *         srand(<unsigned int> time(NULL))             # <<<<<<<<<<<<<<
 * 
...
/* "graduate_design/cylib/circle.pyx":48
 *         srand(<unsigned int> time(NULL))
 * 
 *     cdef inline void generate_one(self, double[::1] circle) nogil:             # <<<<<<<<<<<<<<
 *         cdef:
 ...
 */
  if (((__pyx_v_self->size_range != 0.0) != 0)) {
    ...
    /* "graduate_design/cylib/circle.pyx":51
 *         cdef:
 *             double size, padded_size, x, y
 *         size = (rand() % self.size_range + self.min_size) \             # <<<<<<<<<<<<<<
 *             if self.size_range != 0 else self.min_size
 ...
 */
  ...
  /* "graduate_design/cylib/circle.pyx":57
 *         y = rand() % (self.height - 2 * padded_size) + self.bottom + padded_size
 * 
 *         cdef double dist = c_sqrt(c_pow(x - self.center[0], 2) + c_pow(y - self.center[1], 2))             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "graduate_design/cylib/circle.pyx":61
 *             self.generate_one(circle)
 *         else:
 *             circle[0] = x             # <<<<<<<<<<<<<<
 *             circle[1] = y
...
/* "graduate_design/cylib/circle.pyx":65
 *             circle[2] = size
 * 
 *     cpdef list generate(self, int max_num):             # <<<<<<<<<<<<<<
 *         cdef:
...
static PyObject *__pyx_f_15graduate_design_5cylib_6circle_6Circle_generate(struct __pyx_obj_15graduate_design_5cylib_6circle_Circle *__pyx_v_self, int __pyx_v_max_num, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (unlikely(!__Pyx_object_dict_version_matches(((PyObject *)__pyx_v_self), __pyx_tp_dict_version, __pyx_obj_dict_version))) {
      ...
      #endif
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_generate); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
      ...
      if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (PyCFunction)(void*)__pyx_pw_15graduate_design_5cylib_6circle_6Circle_3generate)) {
        ...
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_max_num); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 65, __pyx_L1_error)
  ...
  /* "graduate_design/cylib/circle.pyx":68
 *         cdef:
 *             double circles[9][3]
 ...
 */
  __pyx_t_2 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)9), ((Py_ssize_t)3)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(((PyObject *)__pyx_t_6), PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_6)); __pyx_t_6 = 0;
  __pyx_v_circles_view = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "graduate_design/cylib/circle.pyx":70
 *             double[:, ::1] circles_view = circles
 *             double circle[3]
 *             double[::1] circle_view = circle             # <<<<<<<<<<<<<<
 ...
 *         with nogil:
 */
  __pyx_t_1 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(((PyObject *)__pyx_t_6), PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_6)); __pyx_t_6 = 0;
 ...
 */
          ...
          /*else*/ {
            ...
            /* "graduate_design/cylib/circle.pyx":80
 *                         break
 *                 else:
 *                     circles_view[num][:] = circle_view             # <<<<<<<<<<<<<<
 *                     num += 1
...
if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_circle_view, __pyx_t_8, 1, 1, 0) < 0)) __PYX_ERR(0, 80, __pyx_L4_error)
 ...
 */
  ...
  /* "graduate_design/cylib/circle.pyx":83
 *                     num += 1
 *         cdef:
 *             list es = []             # <<<<<<<<<<<<<<
 *             tuple c
 ...
 */
  ...
  /* "graduate_design/cylib/circle.pyx":85
 *             list es = []
 *             tuple c
 *         for i in range(num):             # <<<<<<<<<<<<<<
 *             c = (
 ...
 */
  ...
  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
    ...
    /* "graduate_design/cylib/circle.pyx":87
 *         for i in range(num):
 *             c = (
 *                 (circles_view[i][0] - circles_view[i][2], circles_view[i][1] - circles_view[i][2]),             # <<<<<<<<<<<<<<
 *                 (circles_view[i][0] + circles_view[i][2], circles_view[i][1] + circles_view[i][2]),
 ...
 */
    ...
    __pyx_t_17 = 2;
    __pyx_t_1 = PyFloat_FromDouble(((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_circles_view.data + __pyx_t_14 * __pyx_v_circles_view.strides[0]) )) + __pyx_t_15)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_circles_view.data + __pyx_t_16 * __pyx_v_circles_view.strides[0]) )) + __pyx_t_17)) ))))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 87, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_16 = __pyx_v_i;
    __pyx_t_17 = 1;
    __pyx_t_14 = __pyx_v_i;
    __pyx_t_15 = 2;
    __pyx_t_2 = PyFloat_FromDouble(((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_circles_view.data + __pyx_t_16 * __pyx_v_circles_view.strides[0]) )) + __pyx_t_17)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_circles_view.data + __pyx_t_14 * __pyx_v_circles_view.strides[0]) )) + __pyx_t_15)) ))))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 87, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
 ...
 */
    ...
    __pyx_t_16 = __pyx_v_i;
    __pyx_t_17 = 2;
    __pyx_t_2 = PyFloat_FromDouble(((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_circles_view.data + __pyx_t_14 * __pyx_v_circles_view.strides[0]) )) + __pyx_t_15)) ))) + (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_circles_view.data + __pyx_t_16 * __pyx_v_circles_view.strides[0]) )) + __pyx_t_17)) ))))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 88, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_16 = __pyx_v_i;
    __pyx_t_17 = 1;
    __pyx_t_14 = __pyx_v_i;
    __pyx_t_15 = 2;
    __pyx_t_1 = PyFloat_FromDouble(((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_circles_view.data + __pyx_t_16 * __pyx_v_circles_view.strides[0]) )) + __pyx_t_17)) ))) + (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_circles_view.data + __pyx_t_14 * __pyx_v_circles_view.strides[0]) )) + __pyx_t_15)) ))))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 88, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
 ...
 */
    ...
    /* "graduate_design/cylib/circle.pyx":90
 *                 (circles_view[i][0] + circles_view[i][2], circles_view[i][1] + circles_view[i][2]),
 *             )
 *             es.append(c)             # <<<<<<<<<<<<<<
 *         return es
 */
    __pyx_t_18 = __Pyx_PyList_Append(__pyx_v_es, __pyx_v_c); if (unlikely(__pyx_t_18 == ((int)-1))) __PYX_ERR(0, 90, __pyx_L1_error)
  }
...
static PyObject *__pyx_pw_15graduate_design_5cylib_6circle_6Circle_3generate(PyObject *__pyx_v_self, PyObject *__pyx_arg_max_num) {
  ...
  assert(__pyx_arg_max_num); {
    __pyx_v_max_num = __Pyx_PyInt_As_int(__pyx_arg_max_num); if (unlikely((__pyx_v_max_num == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 65, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("graduate_design.cylib.circle.Circle.generate", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
static PyObject *__pyx_pf_15graduate_design_5cylib_6circle_6Circle_2generate(struct __pyx_obj_15graduate_design_5cylib_6circle_Circle *__pyx_v_self, int __pyx_v_max_num) {
  ...
  __Pyx_RefNannySetupContext("generate", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_15graduate_design_5cylib_6circle_6Circle_generate(__pyx_v_self, __pyx_v_max_num, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
